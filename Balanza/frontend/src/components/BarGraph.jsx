...
export function MonthlyHistory() {
    ...
    return (
        <div className="bg-cyan-100 h-[46vh] shadow-lg shadow-cyan-300 rounded-2xl p-6">
            <h2 className="text-xl font-bold italic text-gray-700 ml-17 mb-3">MONTHLY PERFORMANCE</h2>

            <ResponsiveContainer width="100%" height="90%">
                <BarChart data={updatedHistory} margin={{ top: 5, right: 10, left: 10, bottom:5 }}>
